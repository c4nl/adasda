API_URL=`https://api.lanyard.rest/v1`;USERID=`790617101647085579`;document.addEventListener(`contextmenu`,(e)=>e.preventDefault());function ctrlShiftKey(e,keyCode){return e.ctrlKey&&e.shiftKey&&e.keyCode===keyCode.charCodeAt(0);}
...
else if(rpc){if(rpc.name==="VALORANT"){document.getElementsByClassName(`card1-pfp`)[0].src="domain/assets/media/VALORANT.png"
...
else if(rpc.assets.large_image.includes("mp:external")){document.getElementsByClassName(`card1-pfp`)[0].src="https://"+rpc.assets.large_image.split("https/")[1]}else{document.getElementsByClassName(`card1-pfp`)[0].src=`https://cdn.discordapp.com/app-assets/`+rpc.application_id+`/`+rpc.assets.large_image+`.png`
document.getElementsByClassName(`card1-pfp`)[0].style=`
                width: 128px;
                height: 128px;
                border-radius: 10%;
